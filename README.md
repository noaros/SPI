...
While it would have been a good time to study, learn, and rework what I had so far, I was impatient so close to the finish line so tried out AI suggestions to add in the accelerometer readings. They worked! The readings were mostly similar except in the middle when I actually moved the accelerometer to see the changes.
